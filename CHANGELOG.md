...
- Added additional parameters to the `LDAPConnector` and `LDAPProvider` classes to allow for more flexible configuration of the LDAP connection and server parameters. This allows for better compatibility with different LDAP servers and use cases.
